...
---com.interworldtransport.sailevent.HelpEvents-----------------------------------
<p>
 ...
 */
    public HelpEvents(SailAway pTheGUI) {
	this.ParentGUI=pTheGUI;
	this.sp = new HelpSupportEvents(ParentGUI, 
					ParentGUI.TheMenuBar.mniSupport, 
					this);
	this.ab = new HelpAboutEvents(	ParentGUI, 
					ParentGUI.TheMenuBar.mniAbout, 
					this);
...
/**
 * This method sets the Sail for all Help Menu handlers to influence.
 */
