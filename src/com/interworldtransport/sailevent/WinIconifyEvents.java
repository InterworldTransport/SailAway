...
--------------------------------------------------------------------------------
<br>
---com.interworldtransport.sailevent.WinIconifyEvents<br>
--------------------------------------------------------------------------------
<p>
...
public class WinIconifyEvents implements ActionListener {
 ...
 */
    public WinIconifyEvents(JMenuItem pWin, WinEvents pParent) {
	this.ControlIt=pWin;
	this.Parent=pParent;
	this.ControlIt.addActionListener(this);

	}//end of WinIconifyEvents Menu constructor

/** This is the actual action to be performed by this menu item.
 */
    public void actionPerformed(ActionEvent evt) {
	//Show the Iconify feature;
	System.out.println("Iconifying the GUI now...");
	}//end of action performed method.

    }//end of WinIconifyEvents class
