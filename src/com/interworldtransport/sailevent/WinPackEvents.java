...
--------------------------------------------------------------------------------
<br>
---com.interworldtransport.sailevent.WinPackEvents<br>
--------------------------------------------------------------------------------
<p>
...
public class WinPackEvents implements ActionListener {
 ...
 */
    public WinPackEvents(JMenuItem pWin, WinEvents pParent) {
	this.ControlIt=pWin;
	this.Parent=pParent;
	this.ControlIt.addActionListener(this);

	}//end of WinPackEvents Menu constructor

/** This is the actual action to be performed by this menu item.
 */
    public void actionPerformed(ActionEvent evt) {
	//Show the pack feature;
	System.out.println("Packing the GUI now...");
	}//end of action performed method.

    }//end of WinPackEvents class
